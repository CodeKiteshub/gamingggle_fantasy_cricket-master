...
import 'package:tempalteflutter/controllers/home/home_controller.dart';
import 'package:tempalteflutter/model/home/home_fixture_match.dart';
...
import 'package:tempalteflutter/utils/api_constants.dart';
...
class _HomeScreenState extends State<HomeScreen>
  ...
  // var sheduallist = <HomeFixtureMatch>[];
  ...
  Future<Null> getTeamData(bool pool) async {
    ...
    //     data: {'userId': "138"}, endPoint: MYMATCHRECORD);
  ...
  Widget listItems() {
    return Obx(
      () =>
          ...
          Column(
        children:
            List.generate(homeController.homeFixtureMatchList.length, (index) {
          return MatchesList(
            titel: homeController.homeFixtureMatchList[index].title,
            country1Name:
                homeController.homeFixtureMatchList[index].teamShortName1,
            country2Name:
                homeController.homeFixtureMatchList[index].teamShortName2,
            country1Flag: homeController.homeFixtureMatchList[index].teamImage1,
            country2Flag: homeController.homeFixtureMatchList[index].teamImage2,
            price: "₹2 Lakhs",
            time: homeController.homeFixtureMatchList[index].matchDateTime,
          );
        }),
        // children: <Widget>[
        //   MatchesList(
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    Flexible(
                      child: Text(
                        DateFormat.jms().format(widget.time!),
                        style: TextStyle(
                          fontFamily: 'Poppins',
                          fontSize: ConstanceData.SIZE_TITLE16,
                          color: AllCoustomTheme.getBlackAndWhiteThemeColors(),
